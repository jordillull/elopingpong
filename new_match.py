...
def new_match(player_a, score_a, player_b, score_b):
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        ...
        print "  Usage: ./new_match player_a score_a player_b score_b"
    else:
        new_match(sys.argv[1], int(sys.argv[2]), sys.argv[3], int(sys.argv[4]))
